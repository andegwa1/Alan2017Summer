...
public class SharedPreferenceActivity extends BaseActivity {
    ...
    @BindView(R.id.activity_shared_pref_email)
    EditText emailEditText;
    @BindView(R.id.activity_shared_pref_password)
    ...
    @OnClick(R.id.activity_shared_pref_clear)
...
//        editor.remove(PASSWORD);
    ...
    @OnClick(R.id.activity_shared_pref_login)
    public void login(){
